...
namespace CentralAdminApp.Infra.Data.Migrations
{
    ...
    [Migration("20241210023412_Initial")]
            ...
            modelBuilder.Entity("CentralAdminApp.Domain.Entities.Api", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Ativo = true,
                            DataAlteracao = new DateTime(2024, 12, 9, 23, 34, 8, 20, DateTimeKind.Local).AddTicks(5365),
                            DataInclusao = new DateTime(2024, 12, 9, 23, 34, 8, 20, DateTimeKind.Local).AddTicks(5365),
